	...
	private Color colorGridLineBoard;
        ...
        public String getImagePath(String name){ 
			...
			relPath = "/source/"+name;
                    ...
                    relPath = "\\source\\"+name;
                try {
                    return Config.getInstance().getFilePath(relPath);
        ...
        private void loadImage() {
                ...
                try{
                    bigImg = ImageIO.read(new File(getImagePath("BlockSprites.png")));
                    logoImg = ImageIO.read(new File(getImagePath("logo.png"))); 
                    levelImg = ImageIO.read(new File(getImagePath("level.png")));
